...
// VehicleCommand represents a command to be relayed to a vehicle.
...
// CommandResponse represents the result of executing a vehicle command.
...
const file_gateway_gateway_proto_rawDesc = "" +
	...
	"\fCloudGateway\x12G\n" +
	"\fRelayCommand\x12\x1a.gateway.v1.VehicleCommand\x1a\x1b.gateway.v1.CommandResponseB2Z0github.com/rhadp/parking-fee-service/gen/gatewayb\x06proto3"
...
var file_gateway_gateway_proto_goTypes = []any{
	(*VehicleCommand)(nil),  // 0: gateway.v1.VehicleCommand
	(*CommandResponse)(nil), // 1: gateway.v1.CommandResponse
}
var file_gateway_gateway_proto_depIdxs = []int32{
	0, // 0: gateway.v1.CloudGateway.RelayCommand:input_type -> gateway.v1.VehicleCommand
	1, // 1: gateway.v1.CloudGateway.RelayCommand:output_type -> gateway.v1.CommandResponse

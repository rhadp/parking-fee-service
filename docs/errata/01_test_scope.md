...
| ~~`parking-operator-adaptor`~~ | **Resolved** — spec 08 fully implemented (TG1–TG6) |
...
- ~~Remove `--exclude parking-operator-adaptor` after spec 08 TG2+ completes~~ **Done** (spec 08 TG6)

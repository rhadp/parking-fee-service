# Containerfile for mock-sensors
#
...
RUN cd rhivos && cargo build --release --bin mock-sensors
...
COPY --from=builder /build/rhivos/target/release/mock-sensors /usr/local/bin/mock-sensors

ENTRYPOINT ["mock-sensors"]

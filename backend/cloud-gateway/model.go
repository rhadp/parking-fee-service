...
// CommandRequest represents a lock/unlock command from COMPANION_APP.
...
// CommandStatus represents the status of a submitted command.
...
// NATSCommand represents the command payload published to NATS.

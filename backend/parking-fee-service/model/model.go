...
// Rate represents pricing information for a parking session.
type Rate struct {
...
// AdapterMeta holds metadata needed to download a parking operator adapter.
...
// OperatorResponse is the operator lookup response shape, excluding adapter metadata.

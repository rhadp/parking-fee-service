...
import (
	...
	"github.com/sdv-parking-demo/backend/companion-cli/internal/repl"
)
...
func main() {
	...
	gateway := client.NewGatewayClient(cfg.CloudGatewayURL, cfg.VIN, cfg.Timeout)

	// Create REPL
	r := repl.New(cfg, gateway)
	...
	// Check for positional arguments (e.g., companion-cli lock)

...
func TestBearerTokenEnforcement(t *testing.T) {
	// Test that different tokens are correctly propagated to the Authorization header
	tokens := []string{"token-abc", "my-secret-123", "Bearer-already"}
...
// ---------------------------------------------------------------------------
// TS-09-E11 (companion variant): Companion App Non-2xx Response

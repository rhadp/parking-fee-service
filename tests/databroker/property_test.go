...
func TestPropertyWriteReadRoundtrip(t *testing.T) {
	...
	cases := []testCase{
		...
		},
		{
			...
			value:   `"double_value": 48.1351`,
			checkIn: "48",
		},
		{
			signal:  "Vehicle.CurrentLocation.Longitude",
			value:   `"double_value": 11.5820`,
			checkIn: "11",
		},
		{
			signal:  "Vehicle.Speed",
			value:   `"float_value": 99.9`,
			checkIn: "99",
		},
		{
		...
		},
		{
			...
			value:   `"string_value": "roundtrip-test"`,
			checkIn: "roundtrip-test",
		},
		{
			signal:  "Vehicle.Command.Door.Response",
			value:   `"string_value": "roundtrip-resp"`,
			checkIn: "roundtrip-resp",
		},
	}
...
// TestPropertyCrossTransportEquivalence verifies that for every signal, reading via TCP
// and reading via UDS return identical values after a write on either transport.
// Test Spec: TS-02-P3

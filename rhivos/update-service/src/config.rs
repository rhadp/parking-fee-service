...
//!
//! Loads configuration from a JSON file. Falls back to built-in defaults when
//! the file does not exist (07-REQ-7.E1). Returns an error for invalid JSON
//! (07-REQ-7.E2).
...
mod tests {
    ...
    /// TS-07-14: load_config reads grpc_port, registry_url,
    ///           inactivity_timeout_secs, container_storage_path
    #[test]

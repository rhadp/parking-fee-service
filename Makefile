...
test-integration: ## Run integration tests (requires infra-up)
	...
	@echo "==> Running PARKING_FEE_SERVICE integration tests..."
	@cd tests/integration && GOWORK=off go test -v -count=1 -tags integration -run "TestIntegration_CLI|TestIntegration_Full" ./...

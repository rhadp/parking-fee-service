...
- [x] 1. Set up parking-operator-adaptor project structure
  - [x] 1.1 Create Rust crate structure for parking-operator-adaptor
  ...
  - [x] 1.2 Create parking_adaptor.proto service definition
  ...
  - [x] 1.3 Generate Rust bindings from parking_adaptor.proto
...
- [x] 2. Implement core data models and configuration
  - [x] 2.1 Implement Session and SessionState types
...
- [x] 4. Implement session persistence
  - [x] 4.1 Implement SessionStore struct
...
- [x] 5. Implement DATA_BROKER integration
  - [x] 5.1 Implement LocationReader struct
  ...
  - [x] 5.2 Write property test for location reading
  ...
  - [x] 5.3 Implement StatePublisher struct
  ...
  - [x] 5.4 Implement SignalSubscriber struct
  ...
  - [x] 5.5 Write property test for lock event triggers session start
  ...
  - [x] 5.6 Write property test for unlock event triggers session stop
  ...
  - [x] 5.7 Write property test for DATA_BROKER reconnection
...
- [x] 6. Checkpoint - Verify DATA_BROKER integration
  - Run `cargo test` for unit tests
  - Ensure location reading and state publishing work correctly
  - Ask the user if questions arise


- [x] 7. Implement PARKING_OPERATOR API client
  - [x] 7.1 Implement API request/response models
  ...
  - [x] 7.2 Implement OperatorApiClient struct
  ...
  - [x] 7.3 Write property test for API request completeness (start)
  ...
  - [x] 7.4 Write property test for API request completeness (stop)
...
- [x] 8. Implement ZoneLookupClient for automatic lock events
  - [x] 8.1 Implement ZoneInfo struct and ZoneLookupClient
...
- [x] 9. Checkpoint - Verify API clients
  - Run `cargo test` for API client tests
  - Verify retry logic and error handling work correctly
  - Ask the user if questions arise


- [x] 10. Implement session management
  - [x] 10.1 Implement SessionManager struct
  ...
  - [x] 10.2 Implement start_session(zone_id) for manual gRPC starts
  ...
  - [x] 10.3 Implement start_session_auto() for automatic lock events
  ...
  - [x] 10.4 Implement stop_session() method
  ...
  - [x] 10.5 Implement get_status() and helper methods
  ...
  - [x] 10.6 Write property test for session state publication
  ...
  - [x] 10.7 Write property test for state timestamp recording
  ...
  - [x] 10.8 Write property test for concurrent operation prevention
...
- [x] 11. Implement status polling
  - [x] 11.1 Implement StatusPoller struct
...
- [x] 12. Checkpoint - Verify session management
...
- [x] 13. Implement gRPC service
  - [x] 13.1 Implement ParkingAdaptorImpl struct
  ...
  - [x] 13.2 Implement StartSession RPC handler
  ...
  - [x] 13.3 Implement StopSession RPC handler
  ...
  - [x] 13.4 Implement GetSessionStatus RPC handler
  ...
  - [x] 13.5 Write property test for status response completeness
...
- [x] 14. Implement gRPC server startup with TLS
  - [x] 14.1 Implement main entry point with TLS server
...
- [x] 15. Checkpoint - Verify gRPC service
  - Run `cargo test` for all tests
...
- [x] 17. Checkpoint - Verify complete service
  - Run `cargo test` for all unit and property tests (56 tests passing)
  - Run `cargo clippy` for linting (no warnings)
  - Verify service starts with TLS and accepts connections
  - Ask the user if questions arise

- [x] 18. Integration testing
  - [x] 18.1 Create mock PARKING_OPERATOR for testing
  ...
  - [x] 18.2 Create mock DATA_BROKER for testing
  ...
  - [x] 18.3 Create mock PARKING_FEE_SERVICE for zone lookup testing
...
- [x] 19. Final checkpoint - Verify complete implementation
  - Run `cargo test` for all unit, property, and integration tests (56 tests passing)
  - Run `cargo clippy` for linting (no warnings in parking-operator-adaptor)

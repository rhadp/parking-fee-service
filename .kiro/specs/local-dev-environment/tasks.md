...
- [x] 1. Create orchestration script foundation
  - [x] 1.1 Create `scripts/local-dev.sh` with command parsing (start, stop, status, test, logs)
  ...
  - [x] 1.2 Implement port and health check utility functions
...
- [x] 2. Implement infrastructure service management
  - [x] 2.1 Implement `start_infrastructure()` function
  ...
  - [x] 2.2 Implement `stop_infrastructure()` function
    - Call `podman-compose down` in `infra/compose/`
    - Verify ports are released
    - _Requirements: 2.2, 2.3, 2.4_

- [x] 3. Implement RHIVOS service management
  - [x] 3.1 Implement `build_rhivos()` function
    - Run `cargo build --workspace` in `rhivos/`
    - Handle build failures with clear error messages
    - _Requirements: 6.1_

  - [x] 3.2 Implement `start_rhivos_service()` generic function
  ...
  - [x] 3.3 Implement `start_locking_service()` function
  ...
  - [x] 3.4 Implement `start_update_service()` function
  ...
  - [x] 3.5 Implement `start_parking_operator_adaptor()` function
  ...
  - [x] 3.6 Implement `start_cloud_gateway_client()` function
  ...
  - [x] 3.7 Implement `stop_rhivos_services()` function
...
- [x] 8. Create TMT test infrastructure
  ...
  - [x] 8.2 Create basic integration test scripts
...
- [x] 9. Update documentation
  - [x] 9.1 Update `docs/local-infrastructure.md` with new targets

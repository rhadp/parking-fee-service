...
- [ ] 3. Implement broker client, process module, and main
  - [ ] 3.1 Implement broker module
    ...
    - Uses tonic-generated kuksa.val.v2 client from vendored proto files (see errata 03_kuksa_v2_migration.md)
  ...
  - [ ] 3.4 Add build.rs for proto generation
    - Create `rhivos/locking-service/build.rs` using tonic-build to compile kuksa.val.v2 protos (see errata 03_kuksa_v2_migration.md)
    - Proto files vendored at `rhivos/locking-service/proto/kuksa/val.proto`
  ...
  - [ ] 3.V Verify task group 3
    ...
    - [ ] All previously passing tests still pass: `make test` (cloud-gateway-client failures are pre-existing)
...
- [ ] 5. Wiring verification
  ...
  - [ ] 5.5 Cross-spec entry point verification
    - For each execution path whose entry point is owned by another spec
      ...
      entry point is actually called from production code -- not just from tests
...
| 03-REQ-2.E3 | TS-03-4, TS-03-E11 | 2.2 | command::tests::test_validate_empty_command_id |
...
| 03-REQ-6.E1 | TS-03-E12 | 3.3, 4.5 | tests/locking-service::TestSigtermDuringProcessing |

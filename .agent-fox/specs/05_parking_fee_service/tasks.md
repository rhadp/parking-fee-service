...
- [ ] 5. Wiring verification
  ...
  - [ ] 5.2 Run smoke tests
    - Build binary: `go build ./backend/parking-fee-service/`
    - Start service, verify `/health`, `/operators?lat=48.1375&lon=11.5600`, `/operators/parkhaus-munich/adapter` via test harness
    - Verify SIGTERM graceful shutdown
    - _Test Spec: TS-05-SMOKE-1, TS-05-SMOKE-2, TS-05-SMOKE-3_
    - Tests added: TestSmokeEndToEnd, TestSmokeCustomConfig, TestSmokeErrorPaths, TestSmokeDefaultConfig
  ...
  - [ ] 5.4 Verify config fallback
    ...
    - Covered by TestSmokeCustomConfig and TestSmokeDefaultConfig

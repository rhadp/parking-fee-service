...
- [x] 4. Go mock CLI apps (parking-app-cli, companion-app-cli)
  ...
  - [x] 4.V Verify task group 4
    ...
    - [x] All existing tests still pass: `make check` clean; integration tests in tests/mock-apps all pass
    - [x] No linter warnings: `cd mock && go vet ./...`
    - [x] _Test Spec: TS-09-5, TS-09-6, TS-09-7, TS-09-8, TS-09-9, TS-09-10, TS-09-11, TS-09-12, TS-09-13, TS-09-18, TS-09-19, TS-09-E5, TS-09-E6, TS-09-E10, TS-09-E11_
...
- [ ] 6. Wiring verification
  ...
  - [ ] 6.1 Trace every execution path from design.md end-to-end
    ...
    - Confirm no function in the chain is a stub (Rust: `return vec![]`,
      `todo!()`, `unimplemented!()`; Go: `return nil`, `// TODO`,
  ...
  - [ ] 6.5 Cross-spec entry point verification
    - For each execution path whose entry point is owned by another spec
      ...
      PARKING_OPERATOR_ADAPTOR, companion-app-cli calling CLOUD_GATEWAY),
...
| 09-REQ-4.E1 | TS-09-E1, TS-09-E13 | 4.2 | tests/mock-apps::TestLookupMissingArgs |
...
| 09-REQ-5.E1 | TS-09-E10, TS-09-E14 | 4.3 | tests/mock-apps::TestInstallMissingArgs |
...
| 09-REQ-7.E3 | TS-09-E11, TS-09-E15 | 4.1 | tests/mock-apps::TestHTTPError |

...
- [x] 6. Wiring verification
  ...
  - [x] 6.5 Cross-crate regression check
    ...
    - update-service: all tests pass; mock-sensors and parking-operator-adaptor have pre-existing failures (todo!() stubs or unrelated spec, unrelated to this spec)
